-   [Dialog Acts and Sentence Types](#ResponsePoolsandGroups-DialogActsandSentenceTypes)
    -   [Dialog Acts](#ResponsePoolsandGroups-DialogActs)
    -   [Sentence Types](#ResponsePoolsandGroups-SentenceTypes)
-   [Create Response Groups](#ResponsePoolsandGroups-CreateResponseGroups)
-   [Create Response Pools](#ResponsePoolsandGroups-CreateResponsePools)
-   [Create Response Pool Entry and Tags](#ResponsePoolsandGroups-CreateResponsePoolEntryandTags)
-   [Annotate Response Pool Entries](#ResponsePoolsandGroups-AnnotateResponsePoolEntries)
-   [Annotation Editor Interfaces](#ResponsePoolsandGroups-AnnotationEditorInterfaces)
    -   [Styling Tab](#ResponsePoolsandGroups-StylingTab)
        -   [Text Styles](#ResponsePoolsandGroups-TextStyles)
        -   [HR and BR Styles](#ResponsePoolsandGroups-HRandBRStyles)
    -   [Speech Tab](#ResponsePoolsandGroups-SpeechTab)
-   [Use Dynamic Content in Response Pools](#ResponsePoolsandGroups-UseDynamicContentinResponsePools)
    -   [AIML Template Section](#ResponsePoolsandGroups-AIMLTemplateSection)
    -   [BPN Script Task Profile Tags](#ResponsePoolsandGroups-BPNScriptTaskProfileTags)
        -   [responsePoolService Methods](#ResponsePoolsandGroups-responsePoolServiceMethods)
            -   [activateProfile](#ResponsePoolsandGroups-activateProfile)
            -   [activeProfile](#ResponsePoolsandGroups-activeProfile)
            -   [clearProfile](#ResponsePoolsandGroups-clearProfile)
            -   [getResponsePool](#ResponsePoolsandGroups-getResponsePool)
            -   [isTagActive](#ResponsePoolsandGroups-isTagActive)
            -   [isTagNotActive](#ResponsePoolsandGroups-isTagNotActive)
            -   [areAllTagsActive](#ResponsePoolsandGroups-areAllTagsActive)
            -   [isAnyTagActive](#ResponsePoolsandGroups-isAnyTagActive)
            -   [activeTags](#ResponsePoolsandGroups-activeTags)
            -   [ResponsePoolTagMatchingOperator](#ResponsePoolsandGroups-ResponsePoolTagMatchingOperator)
            -   [ResponsePoolProfile](#ResponsePoolsandGroups-ResponsePoolProfile)
            -   [ResponsePoolProfileBuilder](#ResponsePoolsandGroups-ResponsePoolProfileBuilder)
        -   [responsePoolService Examples](#ResponsePoolsandGroups-responsePoolServiceExamples)
            -   [Activate two tags](#ResponsePoolsandGroups-Activatetwotags)
            -   [Deactivate all tags](#ResponsePoolsandGroups-Deactivatealltags)
            -   [Activate a tag and disable lenient search](#ResponsePoolsandGroups-Activateataganddisablelenientsearch)
            -   [Get all active tags](#ResponsePoolsandGroups-Getallactivetags)
-   [Import and Export Response Pools](#ResponsePoolsandGroups-ImportandExportResponsePools)
